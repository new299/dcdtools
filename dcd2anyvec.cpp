...
int main(int argc, char** argv)
{
  ...
  if(argc<5) {
     ...
     cout << " " << endl;
     cout << "Usage: dcd2anyvec <dcdfile> <pdbfile> <direction> <atom1> <atom2>" << endl;
     cout << " " << endl;
     cout << "This program calculates the angle between a defined vector and the x,y or z axis. " << endl;
